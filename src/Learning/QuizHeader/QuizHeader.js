...
function QuizHeader({state, next}){
    ...
    return(
        <div className= "w-[99%] border-none border-[2px] border-[#1C1C1C] py-[10px] px-[8px] flex absolute top-0 left-0 right-0 min-h-[50px] ">
            ...
            <div className= " absolute -bottom-[10px] left-[2px] w-[99%] h-[5px] bg-[#0000001C] rounded">
                <div 
