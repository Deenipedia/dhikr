...
function  ClockAnimation(){
    return(
        <div>
            <div className="clock-anm-holder">
                <svg className="progress w-[20vw] mr-8 md:mr-0 items-center" height="100%" viewBox="100 0 1318 10912" fill="none"
                ...
                <svg className="min_anm absolute md:top-[1%] top-[2%] left-[32%] md:left-[45%] opacity-0" width="10%" height="10%" viewBox="0 0 723 6359" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="hour_anm absolute md:top-[1%] top-[2%] left-[32%] md:left-[45%] opacity-0" width="10%" height="10%" viewBox="0 0 691 6356" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
            ...
            <div className="clock-anm-holder">
                ...
                <svg className="progress w-[20vw] mr-8 md:mr-0" height="100%" viewBox="100 0 1318 10912" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M1268 10911.7V659.244C1268 659.244 1268 659.158 1268 659.116C1268 322.659 995.248 49.9062 658.791 49.9062C322.334 49.9062 49.582 322.659 49.582 659.116C49.582 995.573 322.334 1268.32 658.791 1268.32C986.729 1268.32 1254.47 1009.22 1267.8 684.555"
                        stroke="black"
